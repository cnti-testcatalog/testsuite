...
#### *To check if namespaces have network policies defined*: [network_policies](docs/LIST_OF_TESTS.md#network-policies)
...
#### *Check if the plateform is using insecure ports for the API server*: [Control_plane_hardening](docs/LIST_OF_TESTS.md#control-plane-harding)
