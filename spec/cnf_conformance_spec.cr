...
describe CnfConformance do
  ...
  it "'all' should run the whole test suite", tags: "happy-path" do
    ...
    (all_result_test_names(final_cnf_results_yml)).should eq(["privileged", "increase_capacity", "decrease_capacity", "ip_addresses", "liveness", "readiness", "install_script_helm", "helm_chart_valid", "helm_chart_published","helm_deploy", "reasonable_image_size", "reasonable_startup_time", "nodeport_not_used"])
  end
