...
describe "Private Registry: Image" do
  before_all do
    ...
    Dockerd.exec("docker tag coredns/coredns:1.6.7 registry:5000/coredns:1.6.7", force_output: true)
    Dockerd.exec("docker push registry:5000/coredns:1.6.7", force_output: true)

    # This is required for the test that uses the sample_local_registry_org_image CNF
    Dockerd.exec("docker tag coredns/coredns:1.6.7 registry:5000/coredns-sample-org/coredns:1.6.7", force_output: true)
    Dockerd.exec("docker push registry:5000/coredns-sample-org/coredns:1.6.7", force_output: true)
  end
...
describe "Private Registry: Rolling" do
  before_all do
    ...
    Dockerd.exec("docker tag coredns/coredns:1.8.0 registry:5000/coredns:1.8.0", force_output: true)
    Dockerd.exec("docker push registry:5000/coredns:1.8.0", force_output: true)
  end
