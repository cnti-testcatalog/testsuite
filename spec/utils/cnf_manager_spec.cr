...
describe "SampleUtils" do
  ...
  it "'CNFManager::Points.all_task_test_names' should return all tasks names", tags: ["points"] do
    CNFManager::Points.clean_results_yml
<<<<<<< HEAD
    tags = ["versioned_tag", "cni_compatibility",
            "reasonable_image_size", "reasonable_startup_time",
            "single_process_type", "privileged", "non_root_user",
            "privilege_escalation", "symlink_file_system",
...
=======
    tags = ["versioned_tag", "cni_compatible", "reasonable_image_size", "reasonable_startup_time", "single_process_type", "privileged", "non_root_user", "privilege_escalation", "symlink_file_system", "application_credentials", "host_network", "increase_capacity", "decrease_capacity","pod_network_latency", "pod_network_corruption", "pod_network_duplication", "pod_delete", "pod_io_stress", "pod_memory_hog", "disk_fill", "ip_addresses", "liveness", "readiness", "rolling_update", "rolling_downgrade", "rolling_version_change", "rollback", "nodeport_not_used", "hostport_not_used", "hardcoded_ip_addresses_in_k8s_runtime_configuration", "secrets_used", "immutable_configmap" , "helm_deploy", "node_drain", "install_script_helm", "helm_chart_valid", "helm_chart_published", "volume_hostpath_not_found", "no_local_volume_configuration", "service_account_mapping", "privileged_containers", "network_policies", "non_root_containers", "host_pid_ipc_privileges", "linux_hardening", "resource_policies", "immutable_file_systems", "hostpath_mounts", "log_output", "prometheus_traffic"]
>>>>>>> b1ddbd8af4816155c228b4d3e6f84243dd06d354
