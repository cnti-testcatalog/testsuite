...
describe "Helm" do
  ...
  it "'curl_local_response()' should return the information about the curl installation", tags: "happy-path"  do
    (curl_local_response(true)).should eq("") 
  end

  it "'curl_version()' should return the information about the curl version", tags: "happy-path"  do
    (curl_version(curl_global_response)).should match(/(([0-9]{1,3}[\.]){1,2}[0-9]{1,3})/)
    (curl_version(curl_local_response)).should contain("")
  end

  it "'curl_installations()' should return the information about the curl installation", tags: "happy-path"  do
