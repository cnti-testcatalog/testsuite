...
describe "Wget" do
  ...
  it "'wget_local_response()' should return the information about the wget installation", tags: "happy-path"  do
    (wget_local_response(true)).should eq("") 
  end

  it "'wget_version()' should return the information about the wget version", tags: "happy-path"  do
    (wget_version(wget_global_response)).should match(/(([0-9]{1,3}[\.]){1,2}[0-9]{1,3})/)
    (wget_version(wget_local_response)).should contain("")
  end

  it "'wget_installations()' should return the information about the wget installation", tags: "happy-path"  do
