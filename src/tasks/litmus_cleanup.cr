...
task "uninstall_litmus" do |_, args|
    ...
    if args.named["offline"]?
      ...
      KubectlClient::Delete.file("#{OFFLINE_MANIFESTS_PATH}/litmus-operator-v2.1.0.yaml")
    else
      KubectlClient::Delete.file("https://litmuschaos.github.io/litmus/litmus-operator-v2.1.0.yaml")
    end
