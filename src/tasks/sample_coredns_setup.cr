...
task "bad_helm_cnf_setup", ["helm_local_install"] do |_, args|
  ...
  sample_setup_args(sample_dir: "sample-cnfs/sample-bad_helm_coredns-cnf", deploy_with_chart: false, args: args, verbose: true, wait_count: 2 )
end
...
task "sample_privileged_cnf_whitelisted_setup", ["helm_local_install"] do |_, args|
  ...
  sample_setup_args(sample_dir: "sample-cnfs/sample_whitelisted_privileged_cnf", deploy_with_chart: false, args: args, verbose: true )
end
