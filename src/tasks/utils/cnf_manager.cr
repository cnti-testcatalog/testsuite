...
def self.configmap_temp
  ...
  module CNFAirGap
    ...
    def self.generate(output_file : String = "./airgapped.tar.gz")
      ...
      AirGap.tar_manifest("https://hub.litmuschaos.io/api/chaos/2.0.0?file=charts/generic/pod-delete-corruption/experiment.yaml", output_file, prefix: "pod-delete-")
      AirGap.tar_manifest("https://hub.litmuschaos.io/api/chaos/2.0.0?file=charts/generic/pod-delete-corruption/rbac.yaml", output_file, prefix:  "pod-delete-")
