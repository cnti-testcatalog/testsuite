...
def self.configmap_temp
  ...
  module CNFAirGap
    ...
    def self.generate(output_file : String = "./airgapped.tar.gz")
      ...
      AirGap.tar_manifest("https://hub.litmuschaos.io/api/chaos/1.13.8?file=charts/generic/pod-network-duplication/experiment.yaml", output_file, prefix: "dup-")
      AirGap.tar_manifest("https://hub.litmuschaos.io/api/chaos/1.13.8?file=charts/generic/pod-network-duplication/rbac.yaml", output_file, prefix:  "dup-")
