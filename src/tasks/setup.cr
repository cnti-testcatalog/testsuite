...
task "setup", ["offline", "helm_local_install", "prereqs", "configuration_file_setup", "install_api_snoop", "install_sonobuoy", "install_chart_testing", "cnf_testsuite_setup", "install_kind", "install_cluster_tools"] do  |_, args|
