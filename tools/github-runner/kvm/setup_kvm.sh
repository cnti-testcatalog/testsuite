...
#    ssh root@${RUNNERS[$node]} 'virsh pool-start zfsfilepool'
    ...
    ssh root@${RUNNERS[$node]} 'qemu-img resize -f raw /my-build.raw +40G'
#    ssh root@${RUNNERS[$node]} 'virsh pool-define-as default logical - - /dev/sdb libvirt_lvm \ /dev/libvirt_lvm'
#    ssh root@${RUNNERS[$node]} 'virsh pool-build default'
#    ssh root@${RUNNERS[$node]} 'virsh pool-start default'
#    ssh root@${RUNNERS[$node]} 'virsh pool-autostart default'
