...
once installed please follow the [setup](#Setup) instructions below
...
Pick this option if you want to kick the tires and see how an already setup cnf works with the conformance suite
